  ...
  return (
    <nav className="navbar contentNav">
      ...
      <div className="nav">
        ...
        <Link to="/Belcorp-Hackaton-2018/shopList" className="m-2"><img className="" height="25px" src={IconWhite}></img><span className="badge badge-pill badge-danger">{itemsCount}</span></Link>
      </div>
    </nav>
  )
}
